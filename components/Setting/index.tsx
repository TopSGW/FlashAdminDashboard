                        ...
                        <div className="ml-auto min-[1600px]:ml-[200px] w-[800px] max-[1429px]:mt-10 max-[1428px]:w-full rounded-lg bg-[#1B1B1B] p-3">
                            ...
                            <div className="mt-4 flex md:flex-row w-full max-md:flex-col">
                                <div className="w-[45%] max-md:w-full">
                                    ...
                                    <input className="w-full mt-2 rounded-md bg-[#161616] px-4 py-2 text-[#717171] placeholder:text-[#717171] text-[14px]"
                            ...
                            <div className="mt-4">
                                ...
                                <textarea className=" mt-2 w-full min-h-[150px] bg-[#161616] rounded-lg p-4 text-[#717171] placeholder:text-[#717171]"
                            ...
                            <div className="mt-16 flex justify-end pb-5">
                                ...
                                <button className="ml-4 text-[14px] rounded-md px-4 py-2 bg-[#FBBF04] border-solid border-[1px] border-[#FBBF04]">
                                    Save Change
                                </button>
                            </div>                                                       
                        </div>

...
const StatisticsLineChat = dynamic(()=> import('./AffiliatorStatisticsLineChart'), {ssr: false})
const StatisticsMapChart = dynamic(() => import('./AffiliatorStatisticsMapChart'), {ssr: false})
const StatisticsDoghnut = dynamic(() => import('./AffiliatorStatisticsDoughnut'), {ssr: false})
const StatisticsColumnChart = dynamic(() => import('./AffiliatorStatisticsColumn'), {ssr: false})
                ...
                <div className="w-full bg-[#141414] pb-10 pl-[300px] max-lg:pl-0">
                    ...
                    <div className="mt-5 flex max-[1172px]:flex-wrap max-[1172px]:justify-center min-[1172px]:justify-between px-8 max-sm:px-3">
                        <div className="w-[32%] max-sm:w-full min-w-[296px] max-[1171px]:m-1 rounded-md p-4 max-[1085px]:p-3 bg-[#1B1B1B]">
                            <div className="flex justify-between items-center">
                                <p className="text-[#BCBBB9] text-base">Affiliates Total Sales</p>
                        ...
                        <div className="w-[32%] max-sm:w-full min-w-[296px] max-[1171px]:m-1 rounded-md p-4 max-[1085px]:p-3 bg-[#1B1B1B]">
                            <div className="flex justify-between items-center">
                                <p className="text-[#BCBBB9] text-base">Affiliates Total Order</p>
                                <Image src={baselineMore} width={24} alt={""}/>
                            </div>
                        ...
                        <div className="w-[32%] max-sm:w-full min-w-[296px] max-[1171px]:m-1 rounded-md p-4 max-[1085px]:p-3 bg-[#1B1B1B]">
                            <div className="flex justify-between items-center">
                                <p className="text-[#BCBBB9] text-base">Affiliates Total Profit</p>
                                <Image src={baselineMore} width={24} alt={""}/>
                            </div>
                    ...
                    <div className="mt-5 flex max-[900px]:flex-col min-[900px]:justify-between px-8 max-sm:px-3">
                        ...
                        <div className="w-[32%] max-[900px]:w-full max-[900px]:mt-5 rounded-lg bg-[#1B1B1B] px-4">
                            <div className="mt-4 flex justify-between items-center">
                                <h1 className="text-white font-bold text-lg">Top Affiliated</h1>
                    ...
                    <div className="mt-5 flex max-[900px]:flex-col min-[900px]:justify-between px-8 max-sm:px-3 ">
                        <div className="w-[48%] max-[900px]:w-full rounded-lg bg-white px-2 pb-2 pt-4">
                            <h3 className="text-black text-sm sm:text-base lg:text-lg">Sales Statistics of Affiliates</h3>

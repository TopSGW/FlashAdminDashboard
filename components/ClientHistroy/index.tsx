                ...
                <div className="w-full bg-black pb-10 pl-[300px] max-lg:pl-0">
                    ...
                    <div className="pt-5 px-5 mt-4">
                        <table className="mt-4 w-full">
                            ...
                            <tbody>
                                <TableItem text={"Not Send"} color={"#F86E51"} bgcolor={"rgba(248, 110, 81, 0.2)"}/>
                                <TableItem text={"Sent"} color={"#55BA68"} bgcolor={"rgba(85, 186, 104, 0.2)"}/>
                                <TableItem text={"Pending"} color={"#FBBF04"} bgcolor={"rgba(251, 191, 4, 0.2)"}/>
                                <TableItem text={"Sent"} color={"#55BA68"} bgcolor={"rgba(85, 186, 104, 0.2)"}/>
                                <TableItem text={"Sent"} color={"#55BA68"} bgcolor={"rgba(85, 186, 104, 0.2)"}/>
                                <TableItem text={"Sent"} color={"#55BA68"} bgcolor={"rgba(85, 186, 104, 0.2)"}/>
                                <TableItem text={"Not Send"} color={"#F86E51"} bgcolor={"rgba(248, 110, 81, 0.2)"}/>

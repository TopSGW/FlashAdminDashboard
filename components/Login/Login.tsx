            ...
            <div className='pt-[14vh]'>
                <div className='mx-auto w-full px-4 sm:w-[600px]'>
                    ...
                    <div className='mt-[80px]'>
                        <p className='text-white text-sm sm:text-base md:text-lg'>Email Address</p>
                    </div>
                    <div className='mt-3 w-full'>
                        <input type="email" className='py-3 px-4 bg-[#161616] text-[#717171] text-base w-full rounded-[10px] 
                        placeholder:text-[#717171] focus:outline-none' placeholder='example@gmail.com'/>
                    </div>
                    <div className='mt-3'>
                        <p className='text-white text-sm sm:text-base md:text-lg'>Password</p>
                    </div>
                    <div className='mt-3 w-full flex flex-row items-center rounded-[10px] bg-[#161616] pr-2'>
                        <input type="password" autoComplete='current-password' id='password' className='py-3 px-4 bg-[#161616] text-[#717171] text-base 
                            w-full rounded-[10px] focus:outline-none' onChange={(e)=>Setpassword(e.target.value)} value={password}/>
                        <Image src={showstate ? eyeshow : eyehidden} alt={"state"} className="w-[1em] cursor-pointer"
                    ...
                    <div className='mt-4 flex flex-row items-center'>
                        ...
                        <p className='text-[#FCC005] text-[0.875rem] ml-auto mr-12 cursor-pointer' onClick={()=>Setpassword("")
                        }>Reset Password?</p>    
                    </div>
                    <div className='w-[300px] mx-auto mt-10'>
                        <button className='w-full mx-auto py-4 text-center bg-[#FBBF04] text-black 
                            text-lg font-bold rounded-sm' onClick={()=>router.push('/dashboard/overview/')}>
                            Log in
                        </button>
                    </div>

...
export default function NewAccount(){
    ...
    const tableData = [
        {section: "No KYC", bgColor: "rgba(248, 110, 81, 0.2)", textColor: "#F86E51"},
        {section: "KYC-3", bgColor: "rgba(85, 186, 104, 0.2)", textColor: "#55BA68"},
        {section: "KYC-2", bgColor: "rgba(251, 191, 4, 0.2)", textColor: "#FBBF04"},
        {section: "KYC-3", bgColor: "rgba(85, 186, 104, 0.2)", textColor: "#55BA68"},
        {section: "KYC-3", bgColor: "rgba(85, 186, 104, 0.2)", textColor: "#55BA68"},
        {section: "KYC-3", bgColor: "rgba(85, 186, 104, 0.2)", textColor: "#55BA68"},
        {section: "KYC-3", bgColor: "rgba(85, 186, 104, 0.2)", textColor: "#55BA68"},
                ...
                <div className="w-full bg-[#141414] pb-10 pl-[300px] max-lg:pl-0">
                    ...
                    <div className="mt-5 w-[87%] max-sm:w-[92%] mx-auto p-4 max-sm:p-3">
                        <div className="flex justify-between items-center">
                            <h1 className="text-white text-base max-sm:text-sm">The most recent accounts</h1>
                        ...
                        <div className="mt-4 px-4 max-sm:px-2">
                            <table className="w-full">
                                <thead>
                                    <tr className="text-white">
                                        <th className="py-2 text-left max-sm:text-sm"> Client name</th>
                                        <th className="py-2 text-left max-sm:text-sm"> Account created</th>
                                        <th className="py-2 text-left max-sm:hidden"> Total Amount</th>
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td className="py-2">
                                                    <div className="w-full flex justify-start">
                                                        <button style={{backgroundColor: data.bgColor,}} className={`w-[78px] px-3 py-1 rounded-md text-[${data.textColor}] text-center text-sm
                            ...
                            <div className="w-full flex justify-center mt-2">
                                <Pagination count={4} color="secondary" shape="rounded"/>
                            </div>
                        </div>                        
                    </div>                    
                </div>

...
export default function HeaderA(){
    ...
    return(
        <div className="px-4 flex flex-row items-center w-full h-[70px] bg-[#1B1B1B] z-[99999]
        fixed">
        <div className="">
        ...
        <div className="ml-auto mr-2 max-sm:hidden cursor-pointer" onClick={()=>router.push('/dashboard/setting')}>
            <div className="flex flex-row items-center">
        ...
        <div className=" ml-auto mr-2 sm:hidden">
            <div className="flex flex-row items-center">
                <Image src={notification} width={18} alt={""} className=" cursor-pointer"/>
                <Image src={menu} width={18} className="ml-2 relative cursor-pointer" alt={""} onClick={()=>dispatch(setmenubarState(!MenuState))}/>
                    <OutsideClickHandler onOutsideClick={()=>{dispatch(setmenubarState(false))}}>

...
const OverviewLineChart = dynamic(() => import('./overviewAffiliatorLineChart'), { ssr: false });
const OverviewDoughnut = dynamic(()=> import('./overviewAffiliatorDoghnut'), {ssr: false})
...
export default function OverviewMainpart(){
    ...
    <div className="pt-5 px-5 mt-4">
        <div className="flex max-[801px]:flex-wrap max-[801px]:justify-center min-[801px]:justify-between">
            <div className="w-[24%] max-[480px]:w-[100%] min-w-[181px] max-[800px]:m-2 max-sm:mx-0 rounded-md p-4 max-sm:w-full max-[1085px]:p-3 bg-[#1B1B1B]">
                <div className="flex justify-between items-center">
                    <p className="text-[#BCBBB9] text-base">Total Sales of Affiliation</p>
            ...
            <div className="w-[24%] max-[480px]:w-[100%] min-w-[181px] max-[800px]:m-2 max-sm:mx-0 rounded-md p-4 max-[1085px]:p-3 bg-[#1B1B1B]">
                <div className="flex justify-between items-center">
                    <p className="text-[#BCBBB9] text-base">Visitors from Affiliation</p>
            ...
            <div className="w-[24%] max-[480px]:w-[100%] min-w-[181px] max-[800px]:m-2 max-sm:mx-0 rounded-md p-4 max-[1085px]:p-3 bg-[#1B1B1B]">
                <div className="flex justify-between items-center">
                    <p className="text-[#BCBBB9] text-base">Orders from Affiliation</p>
            ...
            <div className="w-[24%] max-[480px]:w-[100%] min-w-[181px] max-[800px]:m-2 max-sm:mx-0 rounded-md p-4 max-[1085px]:p-3 bg-[#1B1B1B]">
                <div className="flex justify-between items-center">
                    <p className="text-[#BCBBB9] text-base">Refunded from Affiliation</p>
        ...
        <div className="mt-6 flex md:justify-between max-md:flex-col max-md:justify-center">
            ...
            {/* //bg-[#1B1B1B] */}
                <h1 className="text-black text-center text-lg font-semibold">Revenue vs Orders from Afffliation</h1>
                {/* <Line data={data}/> */}
        ...
        <div className="mt-3 flex xl:justify-between max-xl:flex-col">
            ...
            <div className="w-[65%] max-xl:w-full max-xl:mt-4 rounded-md bg-[#1B1B1B] p-4">
                <div className="flex flex-row items-center">
                    <h1 className="text-white text-lg font-bold">Recent Activity from Afflliation</h1>
                    <button className="bg-[#FBBF04] ml-auto rounded-md px-4 py-2 text-base
                        font-semibold" onClick={()=> dispatch(setOverAffiliator_SeeAllViewValue(true))}>See all</button>                                
                </div>
